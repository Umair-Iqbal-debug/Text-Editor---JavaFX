...
public class MarkovTextGenerator {
	...
	public List<WordNode> getWordList(){
		return wordList;
	}
	...
	public WordNode findWordInWordList(String word) {
		...
		for (WordNode wordNode : wordList) {
			...
			// check if we have already seen the word
	...
	public void display() {
		...
		for(WordNode wordNode: wordList) {
			...
			System.out.print(wordNode.getWord() + ":");
			
			for(WordNode nextWordNode: wordNode.getNextWords()) {
				System.out.print(nextWordNode.getWord()+ "-->");
			}
	...
	public static void main(String[] args) {
		...
		//gen.display();
		System.out.println(gen.generateText(5, "I"));
